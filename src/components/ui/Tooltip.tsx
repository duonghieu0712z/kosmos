...
interface TooltipTriggerProps extends Omit<HTMLProps<HTMLElement>, 'ref'> {
    asChild?: boolean;
    children: ReactNode;
}

interface TooltipContentProps extends Omit<HTMLProps<HTMLDivElement>, 'ref'> {
    children?: ReactNode;
    portal?: boolean;
...
interface TooltipContextValue extends UseFloatingReturn<ReferenceType> {
    ...
    getFloatingProps: (userProps?: HTMLProps<HTMLDivElement>) => Record<string, unknown>;
}
